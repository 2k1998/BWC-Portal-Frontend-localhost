        ...
        Papa.parse(file, {
            ...
            complete: async (results) => {
                ...
                if (!rows || rows.length === 0) {
                    showNotification('CSV file is empty or could not be parsed.', 'warning');
                ...
                if (mappedContacts.length === 0) {
                    ...
                    showNotification('No valid contacts found in the CSV file. Please check the column headers.', 'warning');
                    setIsImporting(false);
                    return;
                }
