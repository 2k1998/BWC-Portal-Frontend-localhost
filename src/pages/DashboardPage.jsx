...
import { calendarApi, taskApi, eventApi, paymentApi } from '../api/apiService';
...
import PaymentWidget from '../components/PaymentWidget'; // <-- Add this import
import CarFinanceWidget from '../components/CarFinanceWidget';
    ...
    return (
        <div className="dashboard-container">
            ...
            <div className="dashboard-grid-container">
                ...
                {/* Payment Widget - Add this new section */}
                {isAdmin && (
                    <div className="dashboard-payment-section">
                        <PaymentWidget />
                        <CarFinanceWidget accessToken={accessToken} paymentApi={paymentApi} />
                    </div>
                )}
            </div>
        </div>
